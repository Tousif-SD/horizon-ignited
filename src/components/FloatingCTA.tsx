  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-fade-in">
      ...
      <div className="relative">
        ...
        <button
          onClick={handleCall}
          className="flex items-center gap-3 bg-gradient-hero text-primary-foreground px-5 py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 font-bold"
        >
